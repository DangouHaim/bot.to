...
<div class="i-section">
	<div class="container">
		...
		<form action="<?php echo esc_url($action); ?>" method="post" id="submit-job-form" data-id="<? echo $_GET["job_id"] ?>" class="job-manager-form light-forms c27-submit-listing-form" enctype="multipart/form-data">
			...
			<?php if ($can_post || \MyListing\Src\Listing::user_can_edit($job_id)) : ?>
				...
				<div class="form-section-wrapper" id="form-section-bot-links">
					<div class="element form-section">
						<div class="pf-head round-icon">
							<div class="title-style-1">
						...
						<div class="pf-body">
							<div class="fieldset-links field-type-links form-group ">
								<div class="field-head">
									<label for="links">
										Add your bot links <small>(optional)</small> </label>
								</div>
								<div class="field ">
									<div class="repeater social-networks-repeater" data-list="[]">
										<div data-repeater-list="botLinks">

											<div data-repeater-item="" style="">
												<select name="botLinks[0][network]" class="ignore-custom-select select2-hidden-accessible" tabindex="-1" aria-hidden="true">
													<option value="">Select Network</option>
													<?
													$terms = get_terms( array(
														'taxonomy' => 'botlinkitems',
														'hide_empty' => false,
														'orderby' => 'id',
													) );
													foreach($terms as $term) {
														?><option value="<? echo $term->term_id ?>"><? echo $term->name ?></option><?
													}
													?>
												</select>
												<input type="text" name="botLinks[0][url]" placeholder="Enter URL...">
