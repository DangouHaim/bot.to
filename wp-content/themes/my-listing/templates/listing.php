    ...
    <div class="container listing-main-info">
        <div class="col-md-6">
            <div class="profile-name <?php echo esc_attr($tagline ? 'has-tagline' : 'no-tagline') ?> <?php echo esc_attr($listing->get_rating() ? 'has-rating' : 'no-rating') ?>">
                <?php if ($listing_logo) : ?>
                    <a class="profile-avatar open-photo-swipe" href="<?php echo esc_url($listing->get_logo('full')) ?>" style="background-image: url('<?php echo esc_url($listing_logo) ?>')"></a>
                <?php endif ?>
                ...
                <h1 class="case27-primary-text">
                    ...
                    <?php if ($listing->editable_by_current_user() && function_exists('wc_get_account_endpoint_url')) :
                        ...
                        ?>
                        <a href="<?php echo esc_url($edit_link) ?>" class="edit-listing" data-toggle="tooltip" data-title="<?php echo esc_attr(_x('Edit listing', 'Single listing edit link title', 'my-listing')) ?>"><i class="mi edit"></i></a>
                    <?php endif ?>
                </h1>
                ...
                <?php if ($menu_item['page'] == 'main' || $menu_item['page'] == 'custom') :
                    ...
                    <div class="container <?php printf('tab-template-%s', $menu_item['template']) ?>">
                        <div class="row <?php echo $menu_item['template'] == 'masonry' ? 'listing-tab-grid' : '' ?>">
                            ...
                            <?php
                            if (($text = $listing->get_field("bot-links"))) {
                                ?>
                                <div class="col-md-12 block-type-author">
                                    <div class="element related-listing-block">
                                        <div class="pf-head">
                                            <div class="title-style-1 title-style-1">
                                                <i class="mi video_circle"></i>
                                                <h5>Bot links</h5>
                                            </div>
                                        </div>
                                        <div class="pf-body">
                            ...
                            if (($text = $listing->get_field("video"))) {
                                ?>
                                <div class="col-md-12 block-type-author">
                                    <div class="element related-listing-block">
                                        <div class="pf-head">
                            ...
                            if (get_post_meta(get_the_ID(), "botLinks", true)) {
                                $botLinks = get_post_meta(get_the_ID(), "botLinks", true);
                                ...
                                <div class="col-md-12 block-type-social_networks">
                                    <div class="element list-block">
                                        ...
                                        <div class="pf-body">
                                            <ul class="details-list social-nav item-count-<? echo count($botLinks) ?>">
                                                <?
                                                foreach ($botLinks as $link) {
                                                    $term = get_term( $link[0] );
                                                    ?>
                                                    <li>
                                                        <a href="<? echo $link[2] ?>" target="&quot;_blank&quot;">
                                                            <i style="border-radius: 5px;" class="<? echo GetIconByTerm($term) ?>"></i>
                                                            <span><? echo $term->name ?></span>
