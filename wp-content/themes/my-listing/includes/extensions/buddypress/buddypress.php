...
class Buddypress {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'c27-buddypress-style', c27()->template_uri( 'includes/extensions/buddypress/assets/styles/buddypress.css' ), [], CASE27_THEME_VERSION );
	}
		...
		bp_core_new_nav_item([
			...
			'screen_function' => function() {
				add_action( 'wp_enqueue_scripts', function() {
					wp_enqueue_style( 'c27-buddypress-listings', c27()->template_uri( 'includes/extensions/buddypress/assets/styles/listings.css' ), [], CASE27_THEME_VERSION );
					wp_enqueue_script( 'c27-buddypress-script', c27()->template_uri( 'includes/extensions/buddypress/assets/scripts/buddypress.js' ), array('jquery'), CASE27_THEME_VERSION, true );
				}, 30 );

				add_action( 'bp_template_content', function() {
					require_once locate_template( 'includes/extensions/buddypress/views/profile/listings.php' );
				} );
