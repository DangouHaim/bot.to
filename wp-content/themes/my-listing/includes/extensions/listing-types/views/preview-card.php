...
<div class="tab-content">
	...
	<div class="result-template-tab-preview-card-content" v-show="currentSubTab == 'preview-card'">
		<h3 class="section-title">
			...
			<span class="subtitle">Need help? Read the <a href="http://docs.mylistingtheme.com/article/configuring-the-preview-card-results-template/" target="_blank">documentation</a> or open a ticket in our <a href="https://helpdesk.27collective.net/" target="_blank">helpdesk</a>.</span>
		</h3>
		...
		<div class="template-wrapper">
			<div class="options">
				...
				<div class="card fields-wrapper" v-show="result.template !== 'list-view'">
					<h5>Head buttons</h5>
