<div class="tab-content">
	...
	<h3 class="section-title">
		...
		<span class="subtitle">Need help? Read the <a href="https://docs.mylistingtheme.com/article/listing-type-fields-tab/" target="_blank">documentation</a> or open a ticket in our <a href="https://helpdesk.27collective.net/" target="_blank">helpdesk</a>.</span>
	</h3>
	...
	<div class="fields-wrapper">
					...
					<div class="field-wrapper" :class="'field--' + field.slug" v-if="field">
						<div class="field toggleable" :class="'field-type-' + field.type + ' ' + (field === state.fields.active ? 'open' : '')">
							<h5 @click="state.fields.active = ( field !== state.fields.active ) ? field : null">
								...
								<span class="actions">
									<span title="Delete this field" @click.prevent="fieldsTab().deleteField(field)" v-show="field.slug != 'job_title'"><i class="mi delete"></i></span>
									<span title="This field cannot be deleted" v-show="field.slug == 'job_title'"><i class="icon-lock-1"></i>&nbsp;</span>
								</span>
							</h5>
							<div class="edit">
		...
		<div class="fields-column right">
			...
			<draggable v-model="state.fields.available" :options="{group: 'listing-fields', animation: 100}" @start="drag=true" @end="drag=false" class="fields-draggable available-fields" :class="drag ? 'active' : ''"	>
				<div v-for="field in state.fields.available">
