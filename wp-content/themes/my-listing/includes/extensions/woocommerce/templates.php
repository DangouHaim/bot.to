...
class Templates {
    ...
    public function locate_template( $template ) {
    	...
    	// (Legacy) Check if it exists in includes/integrations/woocommerce/templates/
    	if ( $fullpath = locate_template( sprintf( 'includes/integrations/woocommerce/templates/%s', $path ) ) ) {
    		return $fullpath;
    	}
